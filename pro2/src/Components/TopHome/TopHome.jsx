  ...
  return (
    <div className='TopHome bg-black  '>
      <Swiper
       ...
       <div className="data absolute inset-x-0 mx-auto md:mx-0 md:left-[10%] lg:left-[15%] top-[10%] md:top-[20%] w-[85%] md:w-[42%] flex flex-col items-center md:items-start gap-3 md:gap-5 text-center md:text-left">
      <div className="top flex flex-col gap-2 md:gap-4 items-center md:items-start">
       <div className=" aler h2 text-white text-4xl md:text-6xl relative w-fit mx-auto md:mx-0"> Alertzy </div>
       ...
       <span className=' text-neutral-300 md:text-neutral-500 text-sm md:text-[17px] ex' > 
        ...
        <div className=" flex text-neutral-300 md:text-neutral-500 text-lg md:text-xl gap-3 md:gap-5 items-center justify-center md:justify-start"> Starting @ 
       ...
       <div className="data absolute inset-x-0 mx-auto md:mx-0 md:left-auto md:right-[10%] lg:right-[15%] top-[10%] md:top-[20%] w-[85%] md:w-[42%] flex flex-col items-center md:items-start gap-3 md:gap-5 text-center md:text-left">
      <div className="top flex flex-col gap-2 md:gap-4 items-center md:items-start">
       <div className=" aler2 h2 text-white text-4xl md:text-6xl relative w-fit mx-auto md:mx-0"> Gertious </div>
       ...
       <div className="data absolute inset-x-0 mx-auto md:mx-0 md:left-[10%] lg:left-[15%] top-[10%] md:top-[23%] w-[85%] md:w-[42%] flex flex-col items-center gap-3 md:gap-5 text-center">
      <div className="top flex flex-col gap-2 md:gap-4 items-center">
       <div className=" aler3 h2 text-white text-4xl md:text-6xl relative w-fit mx-auto pl-5"> Gorgeous </div>
       <div className=" h2 text-[#cca471] text-sm md:text-lg"> Exclusive of Sales Tax </div>
      </div>
       <span className=' text-neutral-300 md:text-neutral-500 text-sm md:text-[17px] ex text-center' > 
        The watch bracelet gives a much far colder personality.Dress watch style. Swiss made luxury watch. Stainless steel case with a brown leather strap. Scratch resistant sapphire crystal.
         </span>
        <div className=" flex text-neutral-300 md:text-neutral-500 text-lg md:text-xl gap-3 md:gap-5 items-center justify-center"> Starting @ 
